...
class rtlluSpider(scrapy.Spider):
    ...
    custom_settings = {
        'ITEM_PIPELINES': {
            'scrapyrtl.pipelines.LUArticlesPipeline': 100
        }
    }
...
class todayrtlluSpider(scrapy.Spider):
    name = "todayrtllu"
    custom_settings = {
        'ITEM_PIPELINES': {
            'scrapyrtl.pipelines.ENArticlesPipeline': 100
        }
    }
    # dont leave our target
    allowed_domains = ['rtl.lu']
...
class frrtlluSpider(scrapy.Spider):
    name = "frrtllu"
    custom_settings = {
        'ITEM_PIPELINES': {
            'scrapyrtl.pipelines.FRArticlesPipeline': 100
        }
    }
    # dont leave our target
    allowed_domains = ['rtl.lu']
    # define where we want to start crawling
    start_urls = ['https://5minutes.rtl.lu/actu/luxembourg']
